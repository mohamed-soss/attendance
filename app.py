...
# Google Sheets setup (assume 'credentials.json' is in the root directory and the sheet is shared with the service account)
...
# Load data from Google Sheets and ensure all columns exist with correct dtypes
try:
